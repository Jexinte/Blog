...
class CommentController
{
     ...
     * @param string $idInCookie  phpsessid
     * 
     * @return bool|null
     */
    public function handleInsertComment(string $comment, array $sessionData, string $idInCookie): ?bool
    {
      ...
      *
      * @param array  $sessionData    sessiondata
      * @param string $titleOfArticle of article
      * @param string $idInCookie     phpsessid
    ...
    public function handleMailToAdmin(array $sessionData, string $titleOfArticle, string $idInCookie): void
    {
        ...
        if ($sessionData["session_id"] == $idInCookie) {
            ...
            $mail->Body = "Cher administrateur, <br><br> Un nouveau commentaire a été publié sur le site par l'utilisateur <strong>$usernameSession</strong>.<br><br> Pour modérer ou répondre à ce commentaire, veuillez vous <a href='http://localhost/P5_Créez%20votre%20premier%20blog%20en%20PHP%20-%20Dembele%20Mamadou/public/?selection=sign_in'>connecter</a> à l'interface d'administration du site : . <br><br>Cordialement,<br><br>L'équipe du site";
            $mail->send();
        }
     ...
     *
     * @param int    $idComment  of comment
     * @param array  $session    sessiondata
     * @param string $idInCookie phpsessid
     * 
     * @return array|null
     */
     ...
     *
     * @param string $valueOfValidation value being processed
     * @param int    $idComment         of comment
     * @param string $feedback          of administrator
     * @param array  $session           sessiondata
     * @param string $idInCookie        phpsessid
     * 
     * @return array|null
     ...
     *
     * @param array  $validation value being processed
     * @param array  $session    sessiondata
     * @param string $idInCookie phpsessid
     * 
     * @return void
